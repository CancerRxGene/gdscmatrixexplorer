...
from scripts.db_loader import upload_anchor
...
@click.option('--anchor_synergy', type=click.Path(exists=True),
              help='Anchor Synergy File (CSV format)',
              prompt='Anchor Synergy File')
def upload_anchor_project(project_name, anchor_combi, anchor_synergy):
    """Upload an anchor project"""
    upload_anchor(anchor_combi_path=anchor_combi, anchor_synergy_path=anchor_synergy, project_name=project_name)
