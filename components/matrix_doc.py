    ...
    if(matrix_projects):
        return html.Div(id="matrix", children=
            dbc.Col(className='text-justify',
               # width=8,
                children=[
            H2("Matrix Combination data", className='text-center'),
            H3("Screen Design"),
            P(["Information on screen design, cell lines, compounds and quality control can be downloaded here: ", Br(),
                    ...
                    " (PDF, 614kB)."]),
            H3("Single agent & combination response"),
