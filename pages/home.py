...
def layout(*args, **kwargs):
    ...
    anchor_projects = session.query(Project).filter(Project.combination_type == 'anchor').order_by(Project.name).all()
    ...
    return html.Div([
        ...
        html.P("An interactive tool for the interpretation of drug combination data generated at the Wellcome Sanger Institute.", className='text-center post-lead'),
