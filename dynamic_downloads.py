...
def generate_matrix_results(project_slug):
    ...
    query = session.query(Project, MatrixResult, Model, Drug,
      ...
      .join(curve_alias, and_(MatrixResult.barcode == curve_alias.barcode,
        ...
        .with_entities(MatrixResult.barcode, MatrixResult.drugset_id,
                       ...
                       MatrixResult.bliss_matrix_so, MatrixResult.bliss_window_size,
                       MatrixResult.bliss_window, MatrixResult.bliss_window_dose1,
                       MatrixResult.bliss_window_dose2, MatrixResult.bliss_window_so,
                       MatrixResult.bliss_window_so_dose1,
                       MatrixResult.bliss_window_so_dose2,
                       MatrixResult.hsa_synergistic_wells, MatrixResult.hsa_matrix,
                       MatrixResult.hsa_matrix_so, MatrixResult.hsa_window_size,
                       MatrixResult.hsa_window, MatrixResult.hsa_window_dose1,
                       MatrixResult.hsa_window_dose2, MatrixResult.hsa_window_so,
                       MatrixResult.hsa_window_so_dose1,
                       MatrixResult.hsa_window_so_dose2,
    ...
    df.columns = \
        ["BARCODE", "DRUGSET_ID", "cmatrix", "CELL_LINE_NAME", "MASTER_CELL_ID",
         "COSMIC_ID", "SIDM", "TISSUE", "CANCER_TYPE", "lib1_tag", "lib1_ID",
         "lib1_name", "lib1_conc", "lib1_RMSE", "lib1_MaxE", "lib1_IC50_ln",
         "lib1_IC50_uM", "lib1_target", "lib1_pathway", "lib1_owner", "lib2_tag",
         "lib2_ID", "lib2_name", "lib2_conc", "lib2_RMSE", "lib2_MaxE", "lib2_IC50_ln",
         "lib2_IC50_uM", "lib2_target", "lib2_pathway", "lib2_owner", "combo_MaxE",
         "Delta_MaxE_lib1", "Delta_MaxE_lib2", "Delta_combo_MaxE_day1",
         "Bliss_synergistic_wells", "Bliss_matrix", "Bliss_matrix_SO", "Bliss_window",
         "Bliss_window_dose1", "Bliss_window_dose2", "Bliss_window_SO",
         "Bliss_window_SO_dose1", "Bliss_window_SO_dose2", "HSA_synergistic_wells",
         "HSA_matrix", "HSA_matrix_SO", "HSA_window", "HSA_window_dose1",
         "HSA_window_dose2", "HSA_window_SO", "HSA_window_SO_dose1",
         "HSA_window_SO_dose2", "day1_intensity_mean", "day1_intensity_sd",
         "day1_viability_mean", "day1_viability_sd", "day1_inhibition_scale",
